---
title: Connolly Grading Contract
output: github_document
params:
  weekonemonday: "2022-01-15"
  name: Alex Connolly
---
...
- [ ]  `r advdate(dayone, 3, topic)`
  ...
  - Finish portfolio piece 1 by `r advdate(dayone, 3, assignment="f")`
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 4  by `r advdate(dayone, 4, assignment="f")`
- [ ] `r advdate(dayone, 5, topic)`
  - Finish Lab 5  by `r advdate(dayone, 5, assignment="f")`
  - Finish portfolio piece 2 by `r advdate(dayone, 5, assignment="f")`
- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 6 by `r advdate(dayone, 6, assignment="f")`
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 7 by `r advdate(dayone, 7, assignment="f")`
  - Finish portfolio piece 3 by `r advdate(dayone, 7, assignment="f")`
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab 8 by `r advdate(dayone, 8, assignment="f")`
  - Finish Unessay 1 due on `r advdate(dayone, 8, assignment="f")`
- [ ] `r advdate(dayone, 9, topic)`
  - Finish Lab 9 by `r advdate(dayone, 9, assignment="f")`
  - Finish  portfolio piece 4 by `r advdate(dayone, 9, assignment="f")`
- [ ] `r advdate(dayone, 10, topic)`
  - Finish Lab 10 by `r advdate(dayone, 10, assignment="f")`
- [ ] `r advdate(dayone, 11, topic)`
  - Finish Lab 11 by `r advdate(dayone, 11, assignment="f")`
  - Finish portfolio piece 5 by `r advdate(dayone, 11, assignment="f")`
- [ ] `r advdate(dayone, 12, topic)`
  - Finish Lab 12 by `r advdate(dayone, 12, assignment="f")`
  - Finish portfolio piece 6 by `r advdate(dayone, 12, assignment="f")`
- [ ] `r advdate(dayone, 13, topic)`
  - Finish portfolio pieces 7 and 8 by `r advdate(dayone, 13, assignment="f")`
- [ ] `r advdate(dayone, 14, topic)`
  - Finish portfolio piece 9 by `r advdate(dayone, 14, assignment="f")`
...
- [ ] Portfolio completion and end-of-semester presentation
  - Due on `r advdate(dayone, 16, assignment="f")`


*This contract and its due dates are able to be changed, +/- 3 days.